...
export const soltrackerVersion = loadPackageVersionGracefully('@aposin/ng-soltracker');
...
export function installAllPeerDependencies(tree: Tree): void {
    ...
    try {
        const peerDependencies = require(`@aposin/ng-soltracker/package.json`).peerDependencies;
        ...
        console.warn('WARNING NG-soltracker PACKAGE AND PACKAGE.JSON NOT FOUND IS IT RUNNING IN TESTS?');
    }
}
