...
```scss
@import '@aposin/ng-soltracker/styles/theming';
```
...
```scss
@import "@aposin/ng-soltracker/styles/theming";
@import "@aposin/ng-soltracker/styles/themes/your-base-theme";
...
...
Our components are themed by the following general tokens. You can overwrite their values in your custom theme. A full list of the current style tokens can be found [here](https://www.github.com/allianz/ng-soltracker/blob/main/projects/ng-soltracker/src/shared-styles/theming/tokens.scss).
